...
return n.createElement("div",{id:"hasher"},n.createElement("div",{id:"input-fields"},h("Password",e.password,t,"password"),h("Identifier",e.passwordId,r),h("Size Limit",i,o,"number")),n.createElement(l.default,{value:e.selectedRange,floatingLabelText:"Output Type",onChange:d.rearg(e.selectRange,[2])},s),n.createElement("div",{id:"output"},m("Output",a),n.createElement(p,{id:"copy-password",primary:!0,"data-clipboard-text":e.output,label:"Copy to clipboard"}),n.createElement(f.default,{secondary:!0,label:u,onClick:e.showHidePassword}),m("Output Size",e.outputSize),m("Entropy",e.entropy)))}function g(e){const[t,n]=i.computePassword(e)
